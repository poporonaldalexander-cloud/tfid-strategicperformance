...
/** Bobot (%) suatu level rantai hasil (Output/Intermediate Outcome/Outcome/Impact)
 *  terhadap skor keseluruhan Outcome strategis terkait. */
export type LevelWeight = { id: string; outcome_id: string; level: string; weight: number };
